...
function getIsPortTaken(port) {
  ...
  return new Promise((resolve, reject) => {
    server = _net.default.createServer().once('error', err => err.code === 'EADDRINUSE' ? resolve(cleanupAndReturn(true)) : reject()).once('listening', () => resolve(cleanupAndReturn(false))).listen(port);
  });
}

async function setup(providedConfig) {
